(function() {
    ...
    function embedIframe() {
      ...
      iframe.src = 'https://squareup.com/appointments/buyer/widget/1494f3ec-7ad1-4d6f-bbda-d9d651e13464/2Q4JCCBEH0R6K';
    ...
    function embedBookingButton() {
      ...
      button.setAttribute("style", "background-color: red; color: white; height: 40px; line-height: 38px; " +
              "padding: 0 28px; border-radius: 3px; font-weight: 500; font-size: 14px; cursor: pointer; " +
              "display: inline-block; text-decoration: none");
      button.setAttribute("href", 'https://squareup.com/appointments/book/1494f3ec-7ad1-4d6f-bbda-d9d651e13464/2Q4JCCBEH0R6K/start');
      button.textContent = "Book Appointment Now";
  
      container.setAttribute("style", "text-align: center", "background-color: black");
    ...
    if (takeOverIframe()) {
      window.location = 'https://squareup.com/appointments/buyer/widget/1494f3ec-7ad1-4d6f-bbda-d9d651e13464/2Q4JCCBEH0R6K';
    } else {
